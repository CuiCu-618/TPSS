...
private:
  ...
  void
  submit_constraints(Table<2, VectorizedArray<Number>> & subdomain_matrix,
  ...
  void
  restrict_matrix_qvp(Table<2, VectorizedArray<Number>> &       subdomain_matrix,
